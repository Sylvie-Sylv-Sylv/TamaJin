...
An OOP Python Game Engine aimed for clean and scalable system design suited for game development with the solidity of the Java programming language by using modular, loosely couple elements.
