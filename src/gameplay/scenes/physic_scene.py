...
class PhysicScene(Scene):
    ...
    def __init__(self):
        ...
        self.narrow_collision_pairs: set[tuple[str, str]] = (
            set()
        )  # (entity_a, entity_b)
        self.narrow_collision_mtv: dict[tuple[str, str], Vec2] = (
            {}
        )  # (entity_a, entity_b) -> MTV vector
        self.narrow_collision_contacts: dict[tuple[str, str], list[Vec2]] = (
            {}
        )  # (entity_a, entity_b) -> list of contact points
