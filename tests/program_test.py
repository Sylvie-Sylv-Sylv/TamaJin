...
def main():
        ...
        set_position = SetNode(DefinedVar(VarType.VEC4, "gl_Position"), VecNode(add, FloatConst(0.0), FloatConst(1.0)))
        ...
        vertices = [
                ...
                Vertex(program.mgl, in_vert=[-0.5, -0.5], in_color=[0.0, 1.0, 0.0]), # Bottom-Left Green
                Vertex(program.mgl, in_vert=[ 0.5, -0.5], in_color=[0.0, 0.0, 1.0]), # Bottom-Right Blue
        ]
